...
function employeeFormValues(formData: FormData) {
  return {
    ...
    clothingSizeTop: String(formData.get("clothingSizeTop") || ""),
    clothingSizePants: String(formData.get("clothingSizePants") || ""),
    clothingSizeShoes: String(formData.get("clothingSizeShoes") || ""),
...
export async function createEmployeeAction(_: unknown, formData: FormData) {
  ...
  await db.employee.create({
    data: {
      ...
      clothingSizeTop: parsed.data.clothingSizeTop || null,
      clothingSizePants: parsed.data.clothingSizePants || null,
      clothingSizeShoes: parsed.data.clothingSizeShoes || null,
